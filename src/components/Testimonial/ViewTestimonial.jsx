...
function ViewTestimonial() {
    ...
    const category_columns = [
        ...
        },
        {
            ...
            minWidth: "210px",
            maxWidth: "211px",
            cell: (row) => <ActionIcon Uniquekey={row._id} remove edit deletePath="/Testimonial" onDeleteClick={() => handleCategoryDelete(row)} isRedirected={true} onEditClick={() => handleCategoryEdit(row)} editPath="/Testimonial" />,
        },
    ];
